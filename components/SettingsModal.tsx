            ...
            <div className="space-y-2">
                ...
                <div className="bg-background p-3 rounded-lg border border-border flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-main">Gemini API Key</p>
                            <p className="text-xs text-secondary">{t('settings.key_manager')}</p>
                        </div>
                    </div>
                    <button 
                        onClick={() => { onClose(); onOpenKeyManager(); }}
                        className="text-xs bg-surface border border-border hover:bg-background text-main px-3 py-1.5 rounded transition shadow-sm"
                    >
                        {t('settings.manage')}
                    </button>
                </div>
                ...
                <div className="flex items-center justify-between py-1">
                    ...
                    <div className="flex bg-background border border-border rounded-lg p-1">
                        <button 
                            ...
                            className={`px-3 py-1 rounded text-xs font-medium transition flex items-center gap-1 ${settings.theme === 'dark' ? 'bg-primary text-white' : 'text-secondary hover:text-main/80'}`}
                        >
                        ...
                        <button 
                            ...
                            className={`px-3 py-1 rounded text-xs font-medium transition flex items-center gap-1 ${settings.theme === 'light' ? 'bg-primary text-white' : 'text-secondary hover:text-main/80'}`}
                        >
                 ...
                 <div className="flex items-center justify-between py-1">
                    ...
                    <div className="flex bg-background border border-border rounded-lg p-1">
                        <button 
                            ...
                            className={`px-3 py-1 rounded text-xs font-medium transition ${settings.language === AppLanguage.VI ? 'bg-primary text-white' : 'text-secondary hover:text-main/80'}`}
                        >
                            Tiếng Việt
                        </button>
                        <button 
                            onClick={() => updateSettings({ language: AppLanguage.EN })}
                            className={`px-3 py-1 rounded text-xs font-medium transition ${settings.language === AppLanguage.EN ? 'bg-primary text-white' : 'text-secondary hover:text-main/80'}`}
                        >
                            English
                        </button>
                    </div>
